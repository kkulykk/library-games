...
export const games: GameMeta[] = [
  ...
  },
  {
    ...
    title: 'Globetrotter',
    description:
      'GeoGuessr-style travel quiz: get dropped into a real 360° panorama anywhere on Earth, look around for clues, then pin the spot on a live world map. Play solo or race your friends.',
    tags: ['multiplayer', 'geography', 'puzzle'],
    status: 'live',
    category: 'online-multiplayer',
    emoji: '🌍',
    short: 'Trust your eyes. Pin the planet.',
    genre: 'GEOGRAPHY / GUESSING',
    hue: 160,
    players: '1–8',
    minutes: 15,
    rating: 4.6,
